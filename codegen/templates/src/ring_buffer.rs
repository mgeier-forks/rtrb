...
// Do not edit this file! It has been auto-generated from `codegen/templates/src/ring_buffer.rs`.
...
unsafe impl<T: Send{{ N_param }}> Sync for RingBuffer<T{{ N_arg }}> {}

// NB: `Send` might be implemented by different storage backends,
// but it is not necessary for correct behavior of the RingBuffer.

impl<T{{ N_param }}> PartialEq for RingBuffer<T{{ N_arg }}> {
    fn eq(&self, other: &Self) -> bool {
        core::ptr::eq(self, other)
    }
}

impl<T{{ N_param }}> Eq for RingBuffer<T{{ N_arg }}> {}
...
{{ doctest_create_ring_buffer(64) }}
    ...
    /// ```
    pub fn producer(&self) -> Option<Producer<'_, T{{ N_arg }}>> {
...
{{ doctest_create_ring_buffer(64) }}
    ...
    /// assert_eq!(c.pop(), Ok(20));
    /// ```
    pub fn consumer(&self) -> Option<Consumer<'_, T{{ N_arg }}>> {
