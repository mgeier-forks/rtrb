...
//!
//! If cacheline padding is desired, use [`rtrb::array`](crate::array).
//!
...
//!
//! ```
//! use rtrb::array_unpadded2::{RingBuffer, PushError, PopError};
//!
...
//!
//! ```
//! use rtrb::array_unpadded2::{Consumer, Producer, RingBuffer};
//!
...
///
/// ```
/// use rtrb::array_unpadded2::CopyToUninit as _;
/// ```
#[doc(inline)]
