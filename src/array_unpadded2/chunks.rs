...
//!
//! ```
//! use rtrb::array_unpadded2::{Consumer, Producer};
//!
...
//!
//! ```
//! use rtrb::array_unpadded2::{Producer, ChunkError::TooFewSlots};
//!
...
/// ```
/// use rtrb::array_unpadded2::chunks::{WriteChunk, WriteChunkUninit};
...
/// ```compile_fail
/// # use rtrb::array_unpadded2::chunks::WriteChunkUninit;
/// fn assert_sync<X: Sync>() {}
/// assert_sync::<WriteChunkUninit<u8>>();
/// ```
/// ```compile_fail
/// # use rtrb::array_unpadded2::chunks::WriteChunk;
/// # fn assert_sync<X: Sync>() {}
...
impl<T> WriteChunkUninit<'_, T> {
    ...
    ///
    /// ```
    /// use rtrb::array_unpadded2::{PopError, RingBuffer};
    ///
    /// let rb = RingBuffer::<_, 4>::new();
    /// let mut producer = rb.producer().unwrap();
    /// let mut consumer = rb.consumer().unwrap();
...
/// ```
/// use rtrb::array_unpadded2::chunks::ReadChunk;
/// fn assert_send<X: Send>() {}
