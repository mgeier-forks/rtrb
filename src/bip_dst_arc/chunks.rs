...
/// ```
/// use rtrb::bip_dst_arc::chunks::{WriteChunk, WriteChunkUninit};
...
/// ```compile_fail
/// # use rtrb::bip_dst_arc::chunks::WriteChunkUninit;
/// fn assert_sync<X: Sync>() {}
/// assert_sync::<WriteChunkUninit<u8>>();
/// ```
/// ```compile_fail
/// # use rtrb::bip_dst_arc::chunks::WriteChunk;
/// # fn assert_sync<X: Sync>() {}
...
impl<T> WriteChunkUninit<'_, T> {
    ...
    ///
    /// ```
    /// use rtrb::bip_dst_arc::{PopError, RingBuffer};
    ///
    /// let (mut producer, mut consumer) = RingBuffer::new(4);
...
/// ```
/// use rtrb::bip_dst_arc::chunks::ReadChunk;
/// fn assert_send<X: Send>() {}
