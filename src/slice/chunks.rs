...
//!
//! ```
//! use rtrb::slice::{Consumer, Producer};
//!
...
//!
//! ```
//! use rtrb::slice::{Producer, ChunkError::TooFewSlots};
//!
...
/// ```
/// use rtrb::slice::chunks::{WriteChunk, WriteChunkUninit};
...
/// ```compile_fail
/// # use rtrb::slice::chunks::WriteChunkUninit;
/// fn assert_sync<X: Sync>() {}
/// assert_sync::<WriteChunkUninit<u8>>();
/// ```
/// ```compile_fail
/// # use rtrb::slice::chunks::WriteChunk;
/// # fn assert_sync<X: Sync>() {}
...
impl<T> WriteChunkUninit<'_, T> {
    ...
    ///
    /// ```
    /// use rtrb::slice::{PopError, RingBuffer};
    ///
    /// let rb = RingBuffer::new(4);
    /// let mut producer = rb.producer().unwrap();
    /// let mut consumer = rb.consumer().unwrap();
...
/// ```
/// use rtrb::slice::chunks::ReadChunk;
/// fn assert_send<X: Send>() {}
