...
//!
//! So far, power-of-two indexing has shown no performance advantage.
//! Apparently, the compiler can do this optimization on its own.
//!
...
//!
//! ```
//! use rtrb::array2::{RingBuffer, PushError, PopError};
//!
...
//!
//! ```
//! use rtrb::array2::{Consumer, Producer, RingBuffer};
//!
...
///
/// ```
/// use rtrb::array2::CopyToUninit as _;
/// ```
#[doc(inline)]
