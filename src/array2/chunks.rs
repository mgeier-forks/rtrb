...
//!
//! ```
//! use rtrb::array2::{Consumer, Producer};
//!
...
//! // TODO:
//! // use rtrb::array2::{Producer, CopyToUninit as _};
//!
...
//! // TODO:
//! // use rtrb::array2::{Producer, CopyToUninit as _, ChunkError::TooFewSlots};
//!
...
//! // TODO:
//! // use rtrb::array2::{Producer, ChunkError::TooFewSlots};
//!
...
/// ```
/// use rtrb::array2::chunks::{WriteChunk, WriteChunkUninit};
...
/// ```compile_fail
/// # use rtrb::array2::chunks::WriteChunkUninit;
/// fn assert_sync<X: Sync>() {}
/// assert_sync::<WriteChunkUninit<u8>>();
/// ```
/// ```compile_fail
/// # use rtrb::array2::chunks::WriteChunk;
/// # fn assert_sync<X: Sync>() {}
...
/// ```
/// use rtrb::array2::chunks::ReadChunk;
/// fn assert_send<X: Send>() {}
...
impl<T> WriteChunkUninit<'_, T> {
    ...
    ///
    /// ```
    /// use rtrb::array2::{PopError, RingBuffer};
    ///
    /// let rb = RingBuffer::<_, 4>::new();
    /// let mut producer = rb.producer().unwrap();
    /// let mut consumer = rb.consumer().unwrap();
