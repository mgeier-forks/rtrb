// Do not edit this file! It has been auto-generated from `codegen/templates/src/chunks.rs.jinja`
...
//!
//! ```
//! use rtrb::embedded::{Consumer, Producer};
//!
...
//! // TODO:
//! // use rtrb::embedded::{Producer, CopyToUninit as _};
//!
...
//! // TODO:
//! // use rtrb::embedded::{Producer, CopyToUninit as _, ChunkError::TooFewSlots};
//!
...
//! // TODO:
//! // use rtrb::embedded::{Producer, ChunkError::TooFewSlots};
//!
...
/// ```
/// use rtrb::embedded::chunks::{WriteChunk, WriteChunkUninit};
...
/// ```compile_fail
/// # use rtrb::embedded::chunks::WriteChunkUninit;
/// fn assert_sync<X: Sync>() {}
/// assert_sync::<WriteChunkUninit<u8, 8>>();
/// ```
/// ```compile_fail
/// # use rtrb::embedded::chunks::WriteChunk;
/// # fn assert_sync<X: Sync>() {}
...
/// ```
/// use rtrb::embedded::chunks::ReadChunk;
/// fn assert_send<X: Send>() {}
