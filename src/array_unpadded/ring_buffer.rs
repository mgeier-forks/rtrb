...
///
/// *See also the [module-level documentation](crate::array_unpadded).*
...
/// assert_sync::<rtrb::array_unpadded::RingBuffer<std::cell::Cell<u8>, 8>>();
/// ```
...
impl<T, const N: usize> RingBuffer<T, N> {
    ...
    /// ```
    ///
    /// See the [module-level documentation](crate::array_unpadded) for `static` usage.
