...
//!
//! ```
//! use rtrb::array_unpadded::RingBuffer;
//!
...
//!
//! ```
//! use rtrb::array_unpadded::{Consumer, Producer};
//!
...
//!
//! ```
//! use rtrb::array_unpadded::{Producer, ChunkError::TooFewSlots};
//!
...
/// ```
/// use rtrb::array_unpadded::chunks::{WriteChunk, WriteChunkUninit};
...
/// ```compile_fail
/// # use rtrb::array_unpadded::chunks::WriteChunkUninit;
/// fn assert_sync<X: Sync>() {}
/// assert_sync::<WriteChunkUninit<u8>>();
/// ```
/// ```compile_fail
/// # use rtrb::array_unpadded::chunks::WriteChunk;
/// # fn assert_sync<X: Sync>() {}
...
impl<T> WriteChunkUninit<'_, T> {
    ...
    ///
    /// ```
    /// use rtrb::array_unpadded::{PopError, RingBuffer};
    ///
    /// let rb = RingBuffer::<_, 4>::new();
    /// let mut producer = rb.producer().unwrap();
    /// let mut consumer = rb.consumer().unwrap();
...
/// ```
/// use rtrb::array_unpadded::chunks::ReadChunk;
/// fn assert_send<X: Send>() {}
