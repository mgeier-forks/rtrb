...
//! // TODO:
//! // use rtrb::vrb_arc2::{Producer, CopyToUninit as _};
//!
...
//! // TODO:
//! // use rtrb::vrb_arc2::{Producer, CopyToUninit as _, ChunkError::TooFewSlots};
//!
...
/// ```
/// use rtrb::vrb_arc2::chunks::{WriteChunk, WriteChunkUninit};
...
/// ```compile_fail
/// # use rtrb::vrb_arc2::chunks::WriteChunkUninit;
/// fn assert_sync<X: Sync>() {}
/// assert_sync::<WriteChunkUninit<u8>>();
/// ```
/// ```compile_fail
/// # use rtrb::vrb_arc2::chunks::WriteChunk;
/// # fn assert_sync<X: Sync>() {}
...
/// ```
/// use rtrb::vrb_arc2::chunks::ReadChunk;
/// fn assert_send<X: Send>() {}
