...
// using the configuration file `codegen/configs/dst_arc2.toml`.
...
//!
//! ```
//! use rtrb::dst_arc2::{Consumer, Producer};
//!
...
//!
//! ```
//! use rtrb::dst_arc2::{Producer, ChunkError::TooFewSlots};
//!
...
/// ```
/// use rtrb::dst_arc2::chunks::{WriteChunk, WriteChunkUninit};
...
/// ```compile_fail
/// # use rtrb::dst_arc2::chunks::WriteChunkUninit;
/// fn assert_sync<X: Sync>() {}
/// assert_sync::<WriteChunkUninit<u8>>();
/// ```
/// ```compile_fail
/// # use rtrb::dst_arc2::chunks::WriteChunk;
/// # fn assert_sync<X: Sync>() {}
...
impl<T> WriteChunkUninit<'_, T> {
    ...
    ///
    /// ```
    /// use rtrb::dst_arc2::{PopError, RingBuffer};
    ///
    /// let (mut producer, mut consumer) = RingBuffer::new(4);
...
/// ```
/// use rtrb::dst_arc2::chunks::ReadChunk;
/// fn assert_send<X: Send>() {}
