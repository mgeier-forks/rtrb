...
//!
//! ```
//! use rtrb::dst_box::{Consumer, Producer};
//!
...
//! // TODO:
//! // use rtrb::dst_box::{Producer, CopyToUninit as _};
//!
...
//! // TODO:
//! // use rtrb::dst_box::{Producer, CopyToUninit as _, ChunkError::TooFewSlots};
//!
...
//! // TODO:
//! // use rtrb::dst_box::{Producer, ChunkError::TooFewSlots};
//!
...
/// ```
/// use rtrb::dst_box::chunks::{WriteChunk, WriteChunkUninit};
...
/// ```compile_fail
/// # use rtrb::dst_box::chunks::WriteChunkUninit;
/// fn assert_sync<X: Sync>() {}
/// assert_sync::<WriteChunkUninit<u8>>();
/// ```
/// ```compile_fail
/// # use rtrb::dst_box::chunks::WriteChunk;
/// # fn assert_sync<X: Sync>() {}
...
/// ```
/// use rtrb::dst_box::chunks::ReadChunk;
/// fn assert_send<X: Send>() {}
...
impl<T> WriteChunkUninit<'_, T> {
    ...
    ///
    /// ```
    /// use rtrb::dst_box::{PopError, RingBuffer};
    ///
    /// let rb = RingBuffer::new(4);
    /// let mut p = rb.producer().unwrap();
    /// let mut c = rb.consumer().unwrap();
