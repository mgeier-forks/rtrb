...
//!
//! ```
//! use rtrb::array::{Consumer, Producer};
//!
...
//! // TODO:
//! // use rtrb::array::{Producer, CopyToUninit as _};
//!
...
//! // TODO:
//! // use rtrb::array::{Producer, CopyToUninit as _, ChunkError::TooFewSlots};
//!
...
//! // TODO:
//! // use rtrb::array::{Producer, ChunkError::TooFewSlots};
//!
...
/// ```
/// use rtrb::array::chunks::{WriteChunk, WriteChunkUninit};
...
/// ```compile_fail
/// # use rtrb::array::chunks::WriteChunkUninit;
/// fn assert_sync<X: Sync>() {}
/// assert_sync::<WriteChunkUninit<u8, 8>>();
/// ```
/// ```compile_fail
/// # use rtrb::array::chunks::WriteChunk;
/// # fn assert_sync<X: Sync>() {}
...
/// ```
/// use rtrb::array::chunks::ReadChunk;
/// fn assert_send<X: Send>() {}
