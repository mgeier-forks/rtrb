...
//!
//! ```
//! use rtrb::dst_arc::{Consumer, Producer};
//!
...
//! // TODO:
//! // use rtrb::dst_arc::{Producer, CopyToUninit as _};
//!
...
//! // TODO:
//! // use rtrb::dst_arc::{Producer, CopyToUninit as _, ChunkError::TooFewSlots};
//!
...
//! // TODO:
//! // use rtrb::dst_arc::{Producer, ChunkError::TooFewSlots};
//!
...
/// ```compile_fail
/// # use rtrb::dst_arc::chunks::WriteChunkUninit;
/// fn assert_sync<X: Sync>() {}
/// assert_sync::<WriteChunkUninit<u8>>();
/// ```
/// ```compile_fail
/// # use rtrb::dst_arc::chunks::WriteChunk;
/// # fn assert_sync<X: Sync>() {}
...
/// ```
/// use rtrb::dst_arc::chunks::ReadChunk;
/// fn assert_send<X: Send>() {}
...
impl<T> WriteChunkUninit<'_, T> {
    ...
    ///
    /// ```
    /// use rtrb::dst_arc::{PopError, RingBuffer};
    ///
    /// let (mut p, mut c) = RingBuffer::new(4);
