...
///
/// *See also the [module-level documentation](crate::bip_slice).*
#[derive(Debug)]
...
/// assert_sync::<rtrb::bip_slice::RingBuffer<std::cell::Cell<u8>>>();
/// ```
