...
//! (and pre-allocated memory in general), see the `shared-memory-slice` example.
//!
//! # Examples
//!
...
//!
//! ```
//! use rtrb::bip_slice::{RingBuffer, PushError, PopError};
//!
...
///
/// ```
/// use rtrb::bip_slice::CopyToUninit as _;
/// ```
#[doc(inline)]
