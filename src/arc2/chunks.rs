...
//! // TODO:
//! // use rtrb::arc2::{Producer, CopyToUninit as _};
//!
...
//! // TODO:
//! // use rtrb::arc2::{Producer, CopyToUninit as _, ChunkError::TooFewSlots};
//!
...
/// ```
/// use rtrb::arc2::chunks::{WriteChunk, WriteChunkUninit};
...
/// ```compile_fail
/// # use rtrb::arc2::chunks::WriteChunkUninit;
/// fn assert_sync<X: Sync>() {}
/// assert_sync::<WriteChunkUninit<u8>>();
/// ```
/// ```compile_fail
/// # use rtrb::arc2::chunks::WriteChunk;
/// # fn assert_sync<X: Sync>() {}
...
/// ```
/// use rtrb::arc2::chunks::ReadChunk;
/// fn assert_send<X: Send>() {}
...
impl<T> WriteChunkUninit<'_, T> {
    ...
    ///
    /// ```
    /// use rtrb::arc2::{PopError, RingBuffer};
    ///
    /// let (mut p, mut c) = RingBuffer::new(4);
